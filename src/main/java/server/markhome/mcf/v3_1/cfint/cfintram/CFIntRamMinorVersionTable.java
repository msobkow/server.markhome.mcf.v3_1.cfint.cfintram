	...
	implements ICFIntMinorVersionTable
{
		...
		ICFIntMinorVersion iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFIntBuffMinorVersion > subdictTenantIdx;
		if( dictByTenantIdx.containsKey( keyTenantIdx ) ) {
			subdictTenantIdx = dictByTenantIdx.get( keyTenantIdx );
		}
		else {
			subdictTenantIdx = new HashMap< $implCommaIJavaOptAtomType$, CFIntBuffMinorVersion >();
			dictByTenantIdx.put( keyTenantIdx, subdictTenantIdx );
		}
		subdictTenantIdx.put( pkey, Buff );

		Map< $implCommaIJavaOptAtomType$, CFIntBuffMinorVersion > subdictMajorVerIdx;
		if( dictByMajorVerIdx.containsKey( keyMajorVerIdx ) ) {
			subdictMajorVerIdx = dictByMajorVerIdx.get( keyMajorVerIdx );
		}
		else {
			subdictMajorVerIdx = new HashMap< $implCommaIJavaOptAtomType$, CFIntBuffMinorVersion >();
		...
		ICFLibKeyHash256 TenantId )
	{
		...
		if( dictByTenantIdx.containsKey( key ) ) {
			...
			Map< $implCommaIJavaOptAtomType$, CFIntBuffMinorVersion > subdictTenantIdx
				= new HashMap< $implCommaIJavaOptAtomType$, CFIntBuffMinorVersion >();
		...
		ICFIntMinorVersion iBuff )
	{
		...
		Map< $implCommaIJavaOptAtomType$, CFIntBuffMinorVersion > subdict;
		...
		if( dictByTenantIdx.containsKey( newKeyTenantIdx ) ) {
			...
			subdict = new HashMap< $implCommaIJavaOptAtomType$, CFIntBuffMinorVersion >();
