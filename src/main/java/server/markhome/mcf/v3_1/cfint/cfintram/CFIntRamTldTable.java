	...
	implements ICFIntTldTable
{
		...
		ICFIntTld iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFIntBuffTld > subdictTenantIdx;
		if( dictByTenantIdx.containsKey( keyTenantIdx ) ) {
			subdictTenantIdx = dictByTenantIdx.get( keyTenantIdx );
		}
		else {
			subdictTenantIdx = new HashMap< ICFLibKeyHash256, CFIntBuffTld >();
		...
		ICFLibKeyHash256 TenantId )
	{
		...
		if( dictByTenantIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFIntBuffTld > subdictTenantIdx
				= new HashMap< ICFLibKeyHash256, CFIntBuffTld >();
		...
		ICFIntTld iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFIntBuffTld > subdict;
		...
		if( dictByTenantIdx.containsKey( newKeyTenantIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFIntBuffTld >();
