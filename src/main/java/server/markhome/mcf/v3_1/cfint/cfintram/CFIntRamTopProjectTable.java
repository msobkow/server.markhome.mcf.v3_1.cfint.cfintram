	...
	implements ICFIntTopProjectTable
{
		...
		ICFIntTopProject iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFIntBuffTopProject > subdictTenantIdx;
		if( dictByTenantIdx.containsKey( keyTenantIdx ) ) {
			subdictTenantIdx = dictByTenantIdx.get( keyTenantIdx );
		}
		else {
			subdictTenantIdx = new HashMap< ICFLibKeyHash256, CFIntBuffTopProject >();
			dictByTenantIdx.put( keyTenantIdx, subdictTenantIdx );
		}
		subdictTenantIdx.put( pkey, Buff );

		Map< ICFLibKeyHash256, CFIntBuffTopProject > subdictTopDomainIdx;
		if( dictByTopDomainIdx.containsKey( keyTopDomainIdx ) ) {
			subdictTopDomainIdx = dictByTopDomainIdx.get( keyTopDomainIdx );
		}
		else {
			subdictTopDomainIdx = new HashMap< ICFLibKeyHash256, CFIntBuffTopProject >();
		...
		ICFLibKeyHash256 TenantId )
	{
		...
		if( dictByTenantIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFIntBuffTopProject > subdictTenantIdx
				= new HashMap< ICFLibKeyHash256, CFIntBuffTopProject >();
		...
		ICFIntTopProject iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFIntBuffTopProject > subdict;
		...
		if( dictByTenantIdx.containsKey( newKeyTenantIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFIntBuffTopProject >();
