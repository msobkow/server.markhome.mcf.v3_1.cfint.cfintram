	...
	implements ICFIntTopDomainTable
{
		...
		ICFIntTopDomain iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFIntBuffTopDomain > subdictTenantIdx;
		if( dictByTenantIdx.containsKey( keyTenantIdx ) ) {
			subdictTenantIdx = dictByTenantIdx.get( keyTenantIdx );
		}
		else {
			subdictTenantIdx = new HashMap< ICFLibKeyHash256, CFIntBuffTopDomain >();
			dictByTenantIdx.put( keyTenantIdx, subdictTenantIdx );
		}
		subdictTenantIdx.put( pkey, Buff );

		Map< ICFLibKeyHash256, CFIntBuffTopDomain > subdictTldIdx;
		if( dictByTldIdx.containsKey( keyTldIdx ) ) {
			subdictTldIdx = dictByTldIdx.get( keyTldIdx );
		}
		else {
			subdictTldIdx = new HashMap< ICFLibKeyHash256, CFIntBuffTopDomain >();
		...
		ICFLibKeyHash256 TenantId )
	{
		...
		if( dictByTenantIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFIntBuffTopDomain > subdictTenantIdx
				= new HashMap< ICFLibKeyHash256, CFIntBuffTopDomain >();
		...
		ICFIntTopDomain iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFIntBuffTopDomain > subdict;
		...
		if( dictByTenantIdx.containsKey( newKeyTenantIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFIntBuffTopDomain >();
