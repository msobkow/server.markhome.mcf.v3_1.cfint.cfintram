	...
	implements ICFIntSubProjectTable
{
		...
		ICFIntSubProject iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFIntBuffSubProject > subdictTenantIdx;
		if( dictByTenantIdx.containsKey( keyTenantIdx ) ) {
			subdictTenantIdx = dictByTenantIdx.get( keyTenantIdx );
		}
		else {
			subdictTenantIdx = new HashMap< ICFLibKeyHash256, CFIntBuffSubProject >();
			dictByTenantIdx.put( keyTenantIdx, subdictTenantIdx );
		}
		subdictTenantIdx.put( pkey, Buff );

		Map< ICFLibKeyHash256, CFIntBuffSubProject > subdictTopProjectIdx;
		if( dictByTopProjectIdx.containsKey( keyTopProjectIdx ) ) {
			subdictTopProjectIdx = dictByTopProjectIdx.get( keyTopProjectIdx );
		}
		else {
			subdictTopProjectIdx = new HashMap< ICFLibKeyHash256, CFIntBuffSubProject >();
		...
		ICFLibKeyHash256 TenantId )
	{
		...
		if( dictByTenantIdx.containsKey( key ) ) {
			...
			Map< ICFLibKeyHash256, CFIntBuffSubProject > subdictTenantIdx
				= new HashMap< ICFLibKeyHash256, CFIntBuffSubProject >();
		...
		ICFIntSubProject iBuff )
	{
		...
		Map< ICFLibKeyHash256, CFIntBuffSubProject > subdict;
		...
		if( dictByTenantIdx.containsKey( newKeyTenantIdx ) ) {
			...
			subdict = new HashMap< ICFLibKeyHash256, CFIntBuffSubProject >();
